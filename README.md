...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jira-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jira-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jira jira-base jira-with-async jira-with-cli
# for installing globally
pixi global install jira jira-base jira-with-async jira-with-cli
```
...
It is possible to list all of the versions of `jira` available on your platform:
...
```
pixi search jira --channel conda-forge
```
